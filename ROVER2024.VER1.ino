...
// WIFI
const char* soft_ap_ssid = "ROVER";
const char* soft_ap_password = "12345678";
const char* host = "ROVER"; // corresponde al nombre del Rover
...
#define API_KEY "AIzaSyD9jO-fNA7xxYZ_3IdGxbcTgWGulmcY2x8"

// Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://rover2024-d1c23-default-rtdb.firebaseio.com/"
    ...
    "<table width='20%' bgcolor='A09F9F' align='center'>"
        "<tr>"
            "<td colspan=2>"
                ...
                "<br>"
                "<center><font size=4><b>Rover Login Page</b></font>"
            "</td>"
            "<br>"
            "<br>"
        "</tr>"
...
// Add list of wifi networks
  ...
  wifiMulti.addAP("Familia L_2.4Ghz_ETB", "182214A*");
